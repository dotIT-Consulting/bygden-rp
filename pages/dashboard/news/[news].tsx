...
import { Anchor, Center, Container, Title, Box, Divider, Text, TypographyStylesProvider, Paper, Image, Group, Avatar } from "@mantine/core";
  ...
  return (
    <Container mt="5vh">
      <Paper p="xl">
        ...
        <Group mt={16}>
          <Avatar src={blog?.author?.authorPicture?.url} alt={blog?.author?.authorName} radius="xl" />
          <div>
        ...
        <TypographyStylesProvider>
          <div dangerouslySetInnerHTML={{ __html: blog?.blog?.blogBody?.html }} />
        </TypographyStylesProvider>
      </Paper>
    </Container>
  );
